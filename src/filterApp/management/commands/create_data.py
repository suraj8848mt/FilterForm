...
from filterApp.models import Author, Category, Journal
...
authors = ['john', 'Michale', 'Luke', 'Sally', 'Joe', 'Dude', 'Guy', 'Barbara']
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            'file_name',
            type=str,
            help='The txt file that contains journal content')
